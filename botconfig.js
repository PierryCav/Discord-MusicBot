module.exports = {
  Admins: ["966806199448240169", "745235656912928940"], //Admins of the bot
  ExpressServer: true, //If you wanted to make the website run or not
  DefaultPrefix: process.env.Prefix || "N?", //Default prefix, Server Admins can change the prefix
  Port: 3000, //Which port website gonna be hosted
  SupportServer: "https://discord.gg/sbySMS7m3v", //Support Server Link
  Token: process.env.Token || "OTY2MzM1NTk2MzA4MDkwOTQw.YmAQJw.oYfJBy6CIYtMs6TAk89q5pgZeIY", //Discord Bot Token
  ClientID: process.env.Discord_ClientID || "966335596308090940", //Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "zaQxmTWGybghKcwgAzuh1ziwIAr7fVJE", //Discord Client Secret
  ...
  EmbedColor: "#2f3136", //Color of most embeds | Dont edit unless you want a specific color instead of a random one each time
  ...
  Presence: {
    ...
    name: "🎶 ┃ Em breve no seu servidor.", // The message shown
